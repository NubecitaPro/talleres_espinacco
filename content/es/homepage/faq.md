...
weight: 98
header_menu_title: "Preguntas"
navigation_menu_title: "Preguntas"
header_menu: true
...
-- Perfecto, este taller es para soltar la mano y divertirse.

**"¿Qué pasa si no tengo materiales?"** 

-- Yo te presto los rotuladores, solo trae tu propia libreta. Y si te quieres llevar a casa un sketcbook y rotuladores nuevos, simplimente elige pack "Plus".

![Let us get started on a clean slate](images/materiales.png)

**"¿Son tóxicos los rotuladores?"** 

-- No, los Ecoline son tintas acuarelables, seguras y sin olor.
